...
export const CAR_APPROACH_SPEED = 8; // m/s the car drives down the lane
export const CAR_PARK_TIME = 1.2; // turn-in animation duration
export const CAR_SPAWN_FIRST = 5.0; // first car arrives after this long
export const CAR_SPAWN_INTERVAL = 3.4; // seconds between subsequent arrivals
